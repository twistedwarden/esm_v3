...
class SmartFieldMatchingService
{
    ...
    protected $fieldDefinitions = [
        'student_id_number' => [
            'variations' => ['student_id', 'id_number', 'student_no', 'id_no', 'stud_id', 'student_code', 'lrn', 'learner_reference_number'],
            'weight' => 1.5
        ],
        'first_name' => [
            'variations' => ['given_name', 'fname', 'first', 'given'],
            'weight' => 1.2
        ],
        'last_name' => [
            'variations' => ['surname', 'family_name', 'lname', 'last', 'family'],
            'weight' => 1.2
        ],
        'middle_name' => [
            'variations' => ['mname', 'middle', 'mid_name', 'middle_initial', 'mi'],
            'weight' => 1.0
        ],
        'extension_name' => [
            'variations' => ['suffix', 'ext', 'name_extension', 'qualifier', 'generation'],
            'weight' => 0.8
        ],
        'email_address' => [
            'variations' => ['email', 'e_mail', 'mail_address', 'contact_email', 'google_account', 'yahoo_mail'],
            'weight' => 1.4
        ],
        'contact_number' => [
            'variations' => ['mobile', 'phone', 'cellphone', 'tel_no', 'cp_no', 'contact_no', 'telephone', 'mobile_no'],
            'weight' => 1.3
        ],
        'sex' => [
        ...
        'birth_date' => [
            'variations' => ['dob', 'date_of_birth', 'birthday', 'birthdate', 'born_on'],
            'weight' => 1.3
        ],
        'birth_place' => [
            'variations' => ['place_of_birth', 'pob', 'born_at', 'birthplace'],
            'weight' => 1.0
        ],
        'address' => [
            'variations' => ['residence', 'current_address', 'permanent_address', 'location', 'home_address'],
            'weight' => 1.0
        ],
        'course' => [
            'variations' => ['program', 'degree', 'major', 'strand', 'specialization', 'course_enrolled'],
            'weight' => 1.2
        ],
        'year_level' => [
            'variations' => ['year', 'grade', 'level', 'yr_level', 'grade_level', 'academic_level'],
            'weight' => 1.2
        ],
        'enrollment_status' => [
            'variations' => ['status', 'is_enrolled', 'registration_status', 'academic_status'],
            'weight' => 1.1
        ],
    ];
    ...
    {
        $input = strtolower($input);
        $input = str_replace(['_', '-', ' '], '', $input); // Remove improved delimiters
        return $input;
    }
}
