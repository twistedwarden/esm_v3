...
class PartnerSchoolController extends Controller
{
    ...
    /**
     * Match headers using Smart AI-like matching
     */
    public function matchHeaders(Request $request): JsonResponse
    {
        try {
            ...
            // Allow this endpoint to be used even without school assignment for testing
            // if (!$user) { ... }
            ...
            // Use the service to match headers
            // We can also check if we have AI credentials here and use a more advanced service
            // For now, use the robust fuzzy matching
