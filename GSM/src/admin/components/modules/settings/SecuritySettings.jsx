...
const SecuritySettings = () => {
    ...
    const handleChange = (key, value) => {
        // Handle boolean values (for toggle switches)
        if (typeof value === 'boolean') {
            setSettings(prev => ({ ...prev, [key]: value }));
            return;
        }

        // Handle numeric values (for sliders/inputs)
        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    helper: 'Enable two-factor authentication via email',
                    type: 'toggle',
                    ...
                    <div key={section.id} className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                        ...
                        <div className="p-6 space-y-8">
                            {section.items.map(item => {
                                // Handle toggle type
                                if (item.type === 'toggle') {
                                    const value = settings[item.key] !== undefined ? settings[item.key] : true;
                                        ...
                                        <div key={item.key} className="group">
                                            <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg">
                                                ...
                                                <div className="flex items-center gap-3">
                                                    <span className={`text-sm font-semibold px-3 py-1 rounded-md ${value
